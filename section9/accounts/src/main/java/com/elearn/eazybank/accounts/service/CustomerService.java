...
public class CustomerService {
    ...
    public CustomerDetailDTO fetchCustomerDeatils(String correlationId,String mobileNumber){
        ...
        ResponseEntity<LoanDTO> loanDTOResponseEntity = loansFeignClient.fetchLoanDetails(correlationId,customerDetailDTO.getMobileNumber());
        customerDetailDTO.setLoansDto(loanDTOResponseEntity.getBody());
        ResponseEntity<CardDTO> cardDTOResponseEntity = cardsFeignClient.fetchCardDetails(correlationId,customerDetailDTO.getMobileNumber());
